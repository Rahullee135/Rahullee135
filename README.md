...
- 🏥 Building **enterprise healthcare platforms** — real-time validation, dashboards, analytics
- 🔗 Integrating **Salesforce + Zendesk + Kibo OMS** middleware solutions
- 🖥️ Shipped a **desktop app** using Go (Wails) + React with live data viz
- 🚀 Built full-stack apps from **zero to production** — solo frontend architecture
